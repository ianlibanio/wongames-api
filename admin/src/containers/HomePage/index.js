...
import WonLogo from "../../assets/images/logo-won-dark.svg";
...
const FIRST_BLOCK_LINKS = [
  {
    link: "https://strapi.io/documentation/user-docs/latest/getting-started/introduction.html",
...
const SOCIAL_LINKS = [
  {
    name: "GitHub",
    link: "https://github.com/ianlibanio/",
  },
  {
    name: "Twitter",
    link: "https://twitter.com/zMrNull",
  },
];
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <P style={{ marginTop: 7, marginBottom: 0 }}>
                Contact the project maintainer using the links below.
              </P>

              <ALink
                rel="noopener noreferrer"
                href="https://github.com/ianlibanio/wongames-api"
                target="_blank"
              >
                Check the progress
              </ALink>
